...
export default function InteractiveRAGPage() {
  const blogPost = {
    ...
    content: [
      { type: "section", id: "tldr", title: "TL;DR", content: "Interactive RAG integrates retrieval into multi-turn conversations, preserving context and letting users steer follow-ups for better answers." },
      { type: "section", id: "definition", title: "What Is Interactive RAG?", content: "A conversational setting where each user message triggers retrieval over a KB and chat history, then generation with updated context." },
      {
        type: "section",
        id: "use-cases",
      ...
      { type: "section", id: "strengths", title: "Strengths & Weaknesses", content: "Strengths: adjusts on the fly, captures corrections, feels assistant-like. Weaknesses: context management is hard, long chats increase token cost, evaluation is trickier." },
      {
        type: "section",
        id: "metrics",
