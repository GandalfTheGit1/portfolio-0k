...
export default function RePLUGPage() {
  const blogPost = {
    slug: "replug",
    title: "RePLUG: Retrieval for Black‑Box LLMs (Format and Plug)",
    excerpt:
      "Optimize how retrieved docs are formatted and prepended to prompts for closed LLMs. Improve utility without changing the model.",
    ...
    content: [
      { type: "section", id: "tldr", title: "TL;DR", content: "Treat the LLM as a black box. Focus on retrieval quality and prompt packaging (ordering, chunk size, citations)." },
      { type: "section", id: "definition", title: "Definition", content: "RePLUG adapts retrieval for APIs like GPT‑4 by optimizing doc selection and how context is plugged into prompts." },
      { type: "section", id: "formatting", title: "Formatting Tactics", isList: true, items: ["Order by utility (rerank)","Trim to budgets (token caps)","Use headings + citations","De‑duplicate and diversify"] },
      { type: "section", id: "retrieval", title: "Retrieval Setup", isList: true, items: ["Hybrid BM25 + dense","Cross‑encoder reranker","Top‑k by budget (k=3–8)","Domain‑specific filters"] },
      { type: "section", id: "evaluation", title: "Evaluation", isList: true, items: ["Hit@k, NDCG","Answer faithfulness/hallucination","A/B test packaging variants"] },
      { type: "section", id: "limits", title: "Limits & Guards", isList: true, items: ["Context overflow","Citation enforcement","PII scrubbing","Cost ceilings"] },
    ],
  }
      ...
      <article className="container mx-auto px-6 max-w-3xl relative z-10 pb-20">
        ...
        <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="mt-8 mb-8">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/blog/react-rag" className="hidden" aria-hidden="true" />
            <Link href="/blog/react-rag" className="text-indigo-400 hover:text-indigo-300">ReAct RAG</Link>
