...
export default function ContextualRAGPage() {
  const blogPost = {
    slug: "contextual-rag",
    title: "Contextual RAG: Context-Preserved Retrieval that Finds What Matters",
    excerpt:
      "Contextual RAG augments chunks with surrounding context and often uses hybrid retrieval + reranking to boost retrieval accuracy.",
    ...
    content: [
      { type: "section", id: "tldr", title: "TL;DR", content: "Prepend context snippets to chunks before indexing and combine dense + sparse retrieval; rerank to cut failed retrievals significantly." },
      { type: "section", id: "definition", title: "What Is Contextual RAG?", content: "A retrieval technique that preserves broader context within each chunk so similarity search has more clues, combined with BM25 and reranking." },
      {
        type: "section",
        id: "use-cases",
      ...
      { type: "section", id: "strengths", title: "Strengths & Weaknesses", content: "Strengths: large gains in retrieval success and end-to-end accuracy. Weaknesses: extra preprocessing cost, dual indices, relies on blurb quality." },
      {
        type: "section",
        id: "metrics",
