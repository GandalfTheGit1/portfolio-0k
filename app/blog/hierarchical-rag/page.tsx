...
export default function HierarchicalRAGPage() {
  const blogPost = {
    slug: "hierarchical-rag",
    title: "Hierarchical RAG: Top-Down Indexing for Large Corpora",
    excerpt:
      "Hierarchical RAG builds multi-level indexes (topic → section → paragraph) to narrow retrieval efficiently and preserve context.",
    ...
    content: [
      { type: "section", id: "tldr", title: "TL;DR", content: "Search top-level nodes first (documents/topics), then drill into relevant child sections for precise retrieval with lower noise." },
      { type: "section", id: "definition", title: "What Is Hierarchical RAG?", content: "A top-down retrieval process using multi-level indices with summaries/metadata on parents and detailed content on children." },
      {
        type: "section",
        id: "use-cases",
      ...
      { type: "section", id: "strengths", title: "Strengths & Weaknesses", content: "Strengths: efficient narrowing, context preservation, reduced noise. Weaknesses: complex to build/maintain, latency from multi-stage queries, risk of missing if parent retrieval fails." },
      {
        type: "section",
        id: "metrics",
